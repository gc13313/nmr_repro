...
mr.res <- res %>%
  ...
  select(trait, abbrev, id.exposure, id.outcome, outcome, metab_name, Category, Derived, nsnp, type_analyses, priority, method, b, se, pval) 

writexl::write_xlsx(list(mr_res = mr.res), path = "./output/mr_results.xlsx")
